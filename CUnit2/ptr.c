...
//     int a=5,*p=&a;
//     printf("value of a=%d\n",a);
//     printf("value of a using pointer p=%d\n",*p);//dereferring a pointer---means access value of that address stored in a 
//     printf("address  of a=%p\n",&a);//adress of a 
//     printf("address of p=%p\n",&p);//adress of pointer 
//     printf("value of p=%p\n",p);//value stored inside-p thats just the adress of a same as 6th line
//     return 0;
// }
